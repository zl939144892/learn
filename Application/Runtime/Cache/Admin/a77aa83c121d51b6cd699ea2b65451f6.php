            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="name" class="form-control" id="inputname" value="<?php echo ($menu["name"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="radio" name="type" id="optionsRadiosInline2" value="2"<?php if($menu["type"] == 2): ?>checked<?php endif; ?>> 前端栏目
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="m" id="inputPassword3" value="<?php echo ($menu["m"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">控制器:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="c" id="inputPassword3" value="<?php echo ($menu["c"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">方法:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="f" id="inputPassword3" value="<?php echo ($menu["f"]); ?>">
                        </div>
                    </div>
                    <!--<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="radio" name="status" id="optionsRadiosInline2" value="2" <?php if($menu["status"] == 2): ?>checked<?php endif; ?>> 关闭
                        </div>
